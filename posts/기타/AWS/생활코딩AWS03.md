...
![AWS](/images/posts/기타/AWS/생활코딩AWS03/01.jpg)
...
![AWS 버킷 만들기 1](/images/posts/기타/AWS/생활코딩AWS03/02.jpg "AWS 버킷 만들기 1")

버킷만들기를 누르면 이름과 버킷이 생기는 컴퓨터의 위치를 정할 수 있다.<br>
버킷 이름은 다른 사람들의 버킷과 중복될 수 없다.<br>

![AWS 버킷 만들기 2](/images/posts/기타/AWS/생활코딩AWS03/03.jpg "AWS 버킷 만들기 2")
...
![AWS 폴더 만들기](/images/posts/기타/AWS/생활코딩AWS03/04.jpg "AWS 폴더 만들기")
...
![AWS 파일 업로드](/images/posts/기타/AWS/생활코딩AWS03/05.jpg "AWS 파일 업로드")
...
![AWS 파일 권한 수정](/images/posts/기타/AWS/생활코딩AWS03/06.jpg "AWS 파일 권한 수정")
...
![AWS 파일 접근](/images/posts/기타/AWS/생활코딩AWS03/07.png "AWS 파일 외부 접근")
